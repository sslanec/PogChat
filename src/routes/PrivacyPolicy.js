    ...
    <Flex flex={[1, 1, '1px']} flexDirection="column" overflow="auto">
      ...
      >
        ...
        <Text paddingTop={2}>
          ...
          any way outside of the PogChat application itself, including your
          email address and password. The access token received from Twitch upon
          logging in to your account only provides temporary and limited access
          to your account information. This token is saved only to your
          browser's local storage and is cleared upon expiration (up to four
          hours after receipt).
        </Text>
        <Text paddingTop={2}>
